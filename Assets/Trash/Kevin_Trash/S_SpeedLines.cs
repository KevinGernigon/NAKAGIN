...
public class S_SpeedLines : MonoBehaviour
{
    ...
    private float _increaseSpeedLines = 0;
    ...
    private void Update()
    {
        ...
        {
            _shaderMat.SetFloat("_SL_LineDensity", 0.45f / 2 * (playerVelocityx + playerVelocityy + playerVelocityz + 0.1f * _increaseSpeedLines) * 1.08f);
        }
        else
        {
